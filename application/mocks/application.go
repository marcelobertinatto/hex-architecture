...
// MockProductWritter is a mock of ProductWritter interface.
type MockProductWritter struct {
	ctrl     *gomock.Controller
	recorder *MockProductWritterMockRecorder
}

// MockProductWritterMockRecorder is the mock recorder for MockProductWritter.
type MockProductWritterMockRecorder struct {
	mock *MockProductWritter
}

// NewMockProductWritter creates a new mock instance.
func NewMockProductWritter(ctrl *gomock.Controller) *MockProductWritter {
	mock := &MockProductWritter{ctrl: ctrl}
	mock.recorder = &MockProductWritterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductWritter) EXPECT() *MockProductWritterMockRecorder {
	return m.recorder
}

// Save mocks base method.
func (m *MockProductWritter) Save(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductWritterMockRecorder) Save(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductWritter)(nil).Save), product)
}
